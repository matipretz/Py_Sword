...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-12-2023 a las 01:05:04
...
CREATE TABLE `contrasenas` (
  `id` int(11) NOT NULL,
  `servicio` varchar(64) DEFAULT NULL,
...
INSERT INTO `contrasenas` (`id`, `servicio`, `usuario`, `contrasena`, `id_users`) VALUES
(12, 'Netflix', 'carlos@example.com', 'password789', 3),
(14, 'Netflix', 'carocuello.89@gmail.com', '@7$p8MKdPZ3Lgx', 1),
(15, 'Netflix', 'carocuello.89@gmail.com', '@7$p8MKdPZ3Lgx', 1),
(16, 'email', 'carocuello.89@gmail.com', '@7$p8MKdPZ3Lgx', 1),
(17, 'Netflix', 'carocuello.89@gmail.com', '@7$p8MKdPZ3Lgx', 10);
...
--
ALTER TABLE `contrasenas`
  ADD CONSTRAINT `contrasenas_ibfk_1` FOREIGN KEY (`id_users`) REFERENCES `usuarios` (`id`);
COMMIT;
